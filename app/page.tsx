...
const styles: Record<string, CSSProperties> = {
  ...
  loginWrap: {
    minHeight: "100vh",
    background:
      "radial-gradient(circle at 18% 18%, rgba(37,99,235,0.22), transparent 28%), radial-gradient(circle at 82% 12%, rgba(39,193,141,0.18), transparent 26%), linear-gradient(135deg, #E8EEFF 0%, #F8FAFC 48%, #DDE8FF 100%)",
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    padding: 24,
  ...
  loginShell: {
    ...
    borderRadius: 28,
    background: "#F8F5F1",
    border: "10px solid #0B1F45",
    boxShadow: "0 34px 100px rgba(15, 23, 66, 0.26)",
  },
  loginShowcase: {
    position: "relative",
    overflow: "hidden",
    padding: "36px 34px",
    background:
      "radial-gradient(circle, rgba(37,99,235,0.12) 1.6px, transparent 1.8px), linear-gradient(90deg, rgba(37,99,235,0.16) 1px, transparent 1px), linear-gradient(180deg, rgba(37,99,235,0.16) 1px, transparent 1px), #F8F5F1",
  ...
  loginBar: {
    ...
    boxShadow: "8px -8px 0 rgba(11,31,69,0.10)",
  },
  loginInvoiceTile: {
    gridColumn: "3 / 4",
    display: "flex",
  ...
  loginFolderShape: {
    ...
    border: "1.5px solid #0B1F45",
    background: "#FFF38D",
    boxShadow: "18px -18px 0 rgba(37,99,235,0.18)",
  },
  loginPaperShape: {
    position: "relative",
    width: 92,
  ...
  loginCard: {
    ...
    flexDirection: "column",
    justifyContent: "center",
    boxShadow: "16px 0 40px rgba(8,31,69,0.06)",
    backdropFilter: "none",
  },
  loginLogoWrap: {
    width: 72,
    ...
    overflow: "hidden",
    background: "#F2F2F2",
    boxShadow: "0 16px 34px rgba(8,31,69,0.12)",
  },
  loginLogo: {
    width: "100%",
    height: "100%",
  ...
  loginInput: {
    ...
    padding: "10px 12px",
    borderRadius: 0,
    border: "1px solid rgba(11,31,69,0.26)",
    background: "#FFFFFF",
    color: "#0B1F45",
    fontSize: 14,
    lineHeight: 1.35,
